...
class Stripe(PaymentProcessor):
    ...
    def do_payment(self, details):
        print(
            f"Stripe Payment of amount {self.amount} is completed for {details}")
...
class PayPal(PaymentProcessor):
    ...
    def do_payment(self, details):
        print(
            f"PayPal Payment of amount {self.amount} is completed for {details}")
...
# Now while initializing Store class, pass PaymentProcess method
s = Store(PayPal("Book", 1500))
